...
def preview_sync():
    ...
    try:
        ...
        return jsonify(ErrorResponse(error="Failed to preview sync", details=str(e)).model_dump()), 500
...
def execute_sync():
    ...
    try:
        ...
        return jsonify(ErrorResponse(error="Failed to execute sync", details=str(e)).model_dump()), 500
...
def migrate_planner():
    try:
        ...
        return jsonify(ErrorResponse(error="Failed to migrate planner items", details=str(e)).model_dump()), 500
